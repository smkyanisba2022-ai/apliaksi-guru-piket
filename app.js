...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Pasang listener khusus pada tombol tab untuk mencegah form submit bawaan
...
// FUNGSI SWITCH TAB SECARA MURNI
function switchTab(tab) {
  ...
  // Aktifkan tab sesuai yang diklik
  if (tab === 'guru') {
